    ...
    >
        <div class="bg-white rounded-xl shadow-xl p-6 w-full max-w-md max-h-[90vh] overflow-y-auto">
            <div class="flex items-center justify-between mb-4">
                <h5 class="font-semibold text-gray-900 text-base">Dodaj rekord</h5>
                <button
                    type="button"
                    wire:click="$set('showCreatingModal', false)"
            ...
            <div class="flex items-center justify-end gap-2 mt-2">
                <button type="button" wire:click="$set('showCreatingModal', false)"
                ...
                <button type="button" wire:click="createRecord"
